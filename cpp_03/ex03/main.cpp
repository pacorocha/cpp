...
/*   Updated: 2023/01/23 22:30:28 by jfrancis         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void) {
	...
	FragTrap e8t88("8t88");
	FragTrap e8t89;
	DiamondTrap diemond("diemond the mule");
	e8t89 = e8t88;

	diemond.attack(e8t89.getName());
	if (diemond.getEnergyPoints() > 0)
		e8t89.takeDamage(diemond.getAttackDamage());
	e8t89.highFivesGuys();
